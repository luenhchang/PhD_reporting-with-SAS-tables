/*====================================================================
Program Name  		:	Ch4_tabSup04_fixed-effect-etimates-GSCAN-PRSs-on_GSCAN-phenotypes-QIMR-middle-aged-adults_sex-PRS-int-excluded.sas
Path                			:	
...
*/
column report_3rd_node_breaker phenotype name_fixEffect_pThre sex_group /*signi_thres_T4 var_label name_fixEffect_pThre*/
