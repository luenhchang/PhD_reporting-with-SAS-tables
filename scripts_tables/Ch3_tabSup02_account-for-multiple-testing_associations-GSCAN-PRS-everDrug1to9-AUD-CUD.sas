/*====================================================================
Program Name  		:	Ch3_tabSup02_account-for-multiple-testing_associations-GSCAN-PRS-everDrug1to9-AUD-CUD.sas
modifiedfrom			:	NU2tabSup04_percent-variance-target-phenotypes-explained-by-GSCAN-PRS_si_ai_cpd.sas
Path                			:	
...
proc sort data=output.chapter3_tableSup&table_order. ; by order_num; run;
...
*/
column report_3rd_node_breaker phenotype sex_group
...
%def_group(	cVar=phenotype,	option=group, cName=Target phenotype,	 cWide=4 cm,colAlign=left);
%def_display( cVar=sex_group, cName=Sex, isFmt=Y, cFmt=$sexGroups3_. ,cWide=1 cm,	headerAlign=right);

%def_display(	cVar=count_p_lower_threshold1_si,	cName=T1,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold2_si,	cName=T2,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold3_si ,	cName=T3,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold4_si ,	cName=T4,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold5_si ,	cName=T5,	 cWide=0.5 cm,	headerAlign=right);

%def_display(	cVar=count_p_lower_threshold1_ai,	cName=T1,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold2_ai,	cName=T2,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold3_ai ,	cName=T3,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold4_ai ,	cName=T4,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold5_ai ,	cName=T5,	 cWide=0.5 cm,	headerAlign=right);

%def_display(	cVar=count_p_lower_threshold1_cpd,	cName=T1,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold2_cpd,	cName=T2,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold3_cpd ,	cName=T3,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold4_cpd ,	cName=T4,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold5_cpd ,	cName=T5,	 cWide=0.5 cm,	headerAlign=right);

%def_display(	cVar=count_p_lower_threshold1_sc,	cName=T1,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold2_sc,	cName=T2,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold3_sc ,	cName=T3,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold4_sc ,	cName=T4,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold5_sc ,	cName=T5,	 cWide=0.5 cm,	headerAlign=right);

%def_display(	cVar=count_p_lower_threshold1_dpw,	cName=T1,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold2_dpw,	cName=T2,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold3_dpw ,	cName=T3,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold4_dpw ,	cName=T4,	 cWide=0.5 cm,	headerAlign=right);
%def_display(	cVar=count_p_lower_threshold5_dpw ,	cName=T5,	 cWide=0.5 cm,	headerAlign=right);

/*define all the gap variables*/
%def_display(	cVar=gap01	,cName=		,isFmt=N	,cFmt=	,cWide=0.6%);
%def_display(	cVar=gap02	,cName=		,isFmt=N	,cFmt=	,cWide=0.6%);
%def_display(	cVar=gap03	,cName=		,isFmt=N	,cFmt=	,cWide=0.6%);
